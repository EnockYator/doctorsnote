...
function About() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100">
            {/* Hero Section */}
            <div className="relative bg-blue-600 text-white pt-16 pb-6 px-6 text-center flex flex-col items-center">
            ...
            {/* Features Section */}
            <div className="py-16 px-6 grid gap-8 md:grid-cols-3 bg-blue-50">
                <div className="text-center">
                    <img
                        src={SecureImage /*SecureImage*/}
                        alt="Secure Platform"
                        className="w-3/4 h-32 mx-auto mb-4 rounded-lg shadow-md"
                    />
                    <h3 className="text-2xl font-bold text-gray-800">Secure Platform</h3>
                ...
                <div className="text-center">
                    <img
                        ...
                        className="w-3/4 h-32 mx-auto mb-4 rounded-lg shadow-md"
                    />
                    <h3 className="text-2xl font-bold text-gray-800">Ease of Use</h3>
                    <p className="text-gray-600 mt-2">
                ...
                <div className="text-center">
                    <img
                        ...
                        className="w-3/4 h-32 mx-auto mb-4 rounded-lg shadow-md"
                    />
                    <h3 className="text-2xl font-bold text-gray-800">Trusted Professionals</h3>
                    <p className="text-gray-600 mt-2">
            ...
            <div className="py-16 px-6 bg-white">
                <h2 className="text-3xl font-bold text-gray-800 text-center mb-10">What Our Users Say</h2>
